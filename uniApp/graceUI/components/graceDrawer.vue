<template>
	...
	:style="{background:background,zIndex:zIndex, top:top+'px'}">
		...
		:style="{width:width,padding:padding, zIndex:zIndex+1, background:slotBg, height:'100%'}">
			<view @tap.stop="stopFun" style="min-height:100%;">
...
.gdSlideLeft {animation:gdSlideLeft 150ms linear; left:0;}
@keyframes gdSlideRight{ from {right:-300px; } 100% { right:0px; }}
.gdSlideRight {animation:gdSlideRight 150ms linear; right:0;}
