  ...
  <a-modal v-model="formModal" title="入仓" :maskClosable="false">
    <a-form class="modal-form" :form="form">
      ...
      <a-form-item label="禽类（Kg）">
        <a-input v-decorator="['warehousingWeightPoultry',{rules: numberRules}]" placeholder="禽类（Kg）" :disabled="disabled" />
      </a-form-item>
      <a-form-item label="畜类（Kg）">
        <a-input v-decorator="['warehousingWeightLivestock',{rules: numberRules}]" placeholder="畜类（Kg）" :disabled="disabled" />
      </a-form-item>
      <a-form-item label="水产品（Kg）">
        <a-input v-decorator="['warehousingWeightAquatic',{rules: numberRules}]" placeholder="水产品（Kg）" :disabled="disabled" />
      </a-form-item>
      <a-form-item label="其他（Kg）">
        <a-input v-decorator="['warehousingWeightOther',{rules: numberRules}]" placeholder="其他（Kg）" :disabled="disabled" />
      </a-form-item>
    </a-form>
